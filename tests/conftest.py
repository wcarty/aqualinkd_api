...
def _create_ha_package(types_mod):
    ha = types_mod.ModuleType("homeassistant")
    cfg = types_mod.ModuleType("homeassistant.config_entries")
...
def _add_const_core_helpers(types_mod):
    const_mod = types_mod.ModuleType("homeassistant.const")
    ...
    core_mod = types_mod.ModuleType("homeassistant.core")
    ...
    helpers_mod = types_mod.ModuleType("homeassistant.helpers.aiohttp_client")
...
def _add_update_coordinator_stub(types_mod):
    upd_mod = types_mod.ModuleType("homeassistant.helpers.update_coordinator")
...
def _add_aiohttp_stub(types_mod):
    aiohttp_mod = types_mod.ModuleType("aiohttp")
...
def _inject_homeassistant_stub() -> None:
    ...
    _create_ha_package(types_mod)
    _add_const_core_helpers(types_mod)
    _add_update_coordinator_stub(types_mod)
    _add_aiohttp_stub(types_mod)
